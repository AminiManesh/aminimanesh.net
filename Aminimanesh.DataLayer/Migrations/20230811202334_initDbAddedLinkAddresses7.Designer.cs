...
namespace Aminimanesh.DataLayer.Migrations
{
    ...
    [Migration("20230811202334_initDbAddedLinkAddresses7")]
    partial class initDbAddedLinkAddresses7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aminimanesh.DataLayer.Entities.Amin.LinkAddress", b =>
                {
                    b.Property<int>("LinkAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LinkAddressId"));
                    ...
                    b.HasKey("LinkAddressId");

                    b.ToTable("LinkAddresses");
                });
            ...
            modelBuilder.Entity("Aminimanesh.DataLayer.Entities.Amin.History", b =>
                {
                    ...
                    b.HasOne("Aminimanesh.DataLayer.Entities.Amin.LinkAddress", "LinkAddress")
                        .WithMany()
                        .HasForeignKey("LinkAddressId");

                    b.Navigation("HistoryLine");

                    b.Navigation("LinkAddress");
                });
